...
// ResetSessionLeaf restarts the current session from an empty trunk.
// The previous conversation remains accessible as a sibling branch via /tree.
func (e *Extension) ResetSessionLeaf(ctx context.Context) error {
	return hostCallVoid(e, ctx, "host/resetSessionLeaf", struct{}{})
}
