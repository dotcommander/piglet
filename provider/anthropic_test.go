...
// antSSELines builds a mock Anthropic SSE stream.
func antSSELines(lines ...string) string {
...
func TestAnthropic_StreamText(t *testing.T) {
	...
	prov := provider.NewAnthropic(model, func() string { return "sk-ant-test" })
...
func TestAnthropic_StreamToolCall(t *testing.T) {
	...
	prov := provider.NewAnthropic(model, func() string { return "key" })
...
func TestAnthropic_StreamHTTPError(t *testing.T) {
	...
	prov := provider.NewAnthropic(model, func() string { return "bad" })
