...
// gemSSELines builds a mock Google SSE stream.
func gemSSELines(lines ...string) string {
...
func TestGoogle_StreamText(t *testing.T) {
	...
	prov := provider.NewGoogle(model, func() string { return "goog-test" })
...
func TestGoogle_StreamToolCall(t *testing.T) {
	...
	prov := provider.NewGoogle(model, func() string { return "key" })
...
func TestGoogle_StreamHTTPError(t *testing.T) {
	...
	prov := provider.NewGoogle(model, func() string { return "bad-key" })
...
func TestGoogle_StreamEndpointURL(t *testing.T) {
	...
	prov := provider.NewGoogle(model, func() string { return "mykey" })
