...
func TestParseCommitLine(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			line:      "abc1234567890|2026-04-01 10:00:00 -0500|feat(auth): add OAuth2 support",
			wantType:  "feat",
			wantScope: "auth",
		...
		},
		{
			...
			line:      "def4567890123|2026-04-01 10:00:00 -0500|fix!: remove deprecated API",
			wantType:  "fix",
		...
		{
			name:     "docs no scope",
			line:     "ghi7890123456|2026-04-01 10:00:00 -0500|docs: update README",
			wantType: "docs",
			wantMsg:  "update README",
		},
		{
			name:     "non-conventional",
			line:     "jkl0123456789|2026-04-01 10:00:00 -0500|random commit message",
			wantType: "other",
			wantMsg:  "random commit message",
		},
		{
			name:     "subject with pipe",
			line:     "mno3456789012|2026-04-01 10:00:00 -0500|feat: support a|b syntax",
			wantType: "feat",
			wantMsg:  "support a|b syntax",
		},
		{
			name:      "breaking feat with scope",
			line:      "pqr6789012345|2026-04-01 10:00:00 -0500|feat(api)!: redesign endpoints",
			wantType:  "feat",
			wantScope: "api",
